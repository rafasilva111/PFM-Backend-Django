...
from apps.etl_app.etl.load.ingredient.functions import persist_ingredient
from apps.etl_app.etl.transform.ingredient.models import database_proxy, Ingredient as Ingredient_T, Tag as Tag_T
