...
from apps.etl_app.etl.transform.recipe.transformation_functions import remove_special_characters,remove_fraction_characters,\
...
# Transform Models
from apps.etl_app.etl.transform.recipe.models import Recipe, NutritionInformation,IngredientQuantity, Tag, Ingredient, Preparation,database_proxy as transform_database_proxy

# Extract Models
from apps.etl_app.etl.extract.recipe.pingo_doce.models import Recipe as Recipe_, Tag as Tag_, NutritionInformation as NutritionInformation_, Ingredient as Ingredient_, \
